...
public class DBConstants {
    ...
    public static final String DB_PASSWORD = "akone";
    ...
    public static final String FIND_RECURRENT = "select t.ID FROM ticket t WHERE t.VEHICLE_REG_NUMBER = ? AND t.OUT_TIME IS NOT NULL ORDER BY t.IN_TIME DESC LIMIT 1";
