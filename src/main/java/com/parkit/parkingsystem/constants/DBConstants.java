...
public class DBConstants {
    ...
    public static final String GET_LAST_PAID_TICKET = "select t.ID FROM ticket t WHERE t.VEHICLE_REG_NUMBER = ? AND t.OUT_TIME IS NOT NULL ORDER BY t.IN_TIME DESC LIMIT 1";
}
